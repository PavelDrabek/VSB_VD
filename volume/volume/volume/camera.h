...
public:
	...
	void UpdateDirection()
	{
		...
		// http://cs.wikipedia.org/wiki/Sf%C3%A9rick%C3%A1_soustava_sou%C5%99adnic
	...
	void DrawBackground();
	void DrawGrid( float width, int count );
